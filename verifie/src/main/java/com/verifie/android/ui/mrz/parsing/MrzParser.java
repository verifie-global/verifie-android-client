...
public class MrzParser {
    ...
    public MrzDate parseDate(MrzRange range) {
        ...
        try {
            ...
            year = -1;
            System.out.println("Failed to parse MRZ date year " + rawValue(range) + ": " + ex + " : " + mrz + "r: " + r);
        }
        if (year < 0 || year > 99) {
        ...
        try {
            ...
            month = -1;
            System.out.println("Failed to parse MRZ date month " + rawValue(range) + ": " + ex + " : " + mrz + "r: " + r);
        }
        if (month < 1 || month > 12) {
        ...
        try {
            ...
            day = -1;
            System.out.println("Failed to parse MRZ date day " + rawValue(range) + ": " + ex + " : " + mrz + "r: " + r);
        }
        if (day < 1 || day > 31) {
