 ...
 * {@link OcrCameraSource.Builder#setRequestedFps(float)} to specify a frame rate that works well with
...
public class OcrCameraSource {
    ...
    public static class Builder {
        ...
        private OcrCameraSource mOcrCameraSource = new OcrCameraSource();
        ...
        public Builder setFacing(int facing) {
            ...
            mOcrCameraSource.mFacing = facing;
            return this;
        }
         ...
         */
        public OcrCameraSource build() {
            mOcrCameraSource.mFrameProcessor = mOcrCameraSource.new FrameProcessingRunnable(mDetector);
            return mOcrCameraSource;
        }
    }
    ...
    public OcrCameraSource start() throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public OcrCameraSource start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
