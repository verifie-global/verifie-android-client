 ...
 * </ol>
 */
public class OcrGraphicOverlay<T extends OcrGraphicOverlay.Graphic> extends View {
     ...
     * graphics element.  Add instances to the overlay using {@link OcrGraphicOverlay#add(Graphic)}.
     */
    public static abstract class Graphic {
        private OcrGraphicOverlay mOverlay;

        public Graphic(OcrGraphicOverlay overlay) {
            mOverlay = overlay;
        }
