 ...
 */
public final class FrontCameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public FrontCameraPreview(Activity activity, int cameraId, LayoutMode mode) {
