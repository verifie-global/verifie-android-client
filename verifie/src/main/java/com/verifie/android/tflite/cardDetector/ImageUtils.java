...
public class ImageUtils {
  ...
  public static Bitmap cropArea(Bitmap source, RectF rectF) {
    ...
    if (source.getWidth() < rectF.right || source.getHeight() < rectF.bottom) {
      return null;
    }

    return Bitmap.createBitmap(source, ((int) rectF.left), ((int) rectF.top), (int)(rectF.right - rectF.left), (int) (rectF.bottom - rectF.top));
  }
